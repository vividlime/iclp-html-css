  ...
  googleMaps: function (){
    ...
    $(window).resize(wrapContent);
        ...
        var body = $('html, body');
            ...
            //if desktop
            $(document).on('click', '.London', function (e) {
              alert('dsadasas');
              e.preventDefault();
              $('.openaddress').removeClass('openaddress');
              $('#contact-form').addClass('active');
              $('#icon-contact span').hide();
                ...
                $('#addresses').find('address.London').addClass('openaddress');
                slideMap.parent().addClass('open');
                body.animate({scrollTop: $('#'+$(this).data('id')).offset().top - 63 }, 'slow');
              return false;
            });

            $(document).on('click', '.Tokyo', function (e) {
              e.preventDefault();
              $('.openaddress').removeClass('openaddress');
              $('#contact-form').addClass('active');
              $('#icon-contact span').hide();
            ...
            $(document).on('click', '.Beijing', function (e) {
              e.preventDefault();
              $('.openaddress').removeClass('openaddress');
              $('#contact-form').addClass('active');
              $('#icon-contact span').hide();
            ...
            $(document).on('click', '.CapeTown', function (e) {
              e.preventDefault();
              $('.openaddress').removeClass('openaddress');
              $('#contact-form').addClass('active');
              $('#icon-contact span').hide();
            ...
            $(document).on('click', '.Dallas', function (e) {
              e.preventDefault();
              $('.openaddress').removeClass('openaddress');
              $('#contact-form').addClass('active');
              $('#icon-contact span').hide();
            ...
            $(document).on('click', '.Dubai', function (e) {
              e.preventDefault();
              $('.openaddress').removeClass('openaddress');
              $('#contact-form').addClass('active');
              $('#icon-contact span').hide();
            ...
            $(document).on('click', '.HongKong', function (e) {
              e.preventDefault();
              $('.openaddress').removeClass('openaddress');
              $('#contact-form').addClass('active');
              $('#icon-contact span').hide();
            ...
            $(document).on('click', '.KualaLumpur', function (e) {
              e.preventDefault();
              $('.openaddress').removeClass('openaddress');
              $('#contact-form').addClass('active');
              $('#icon-contact span').hide();
            ...
            $(document).on('click', '.Mumbai', function (e) {
              e.preventDefault();
              $('.openaddress').removeClass('openaddress');
              $('#contact-form').addClass('active');
              $('#icon-contact span').hide();
            ...
            $(document).on('click', '.NewYork', function (e) {
              e.preventDefault();
              $('.openaddress').removeClass('openaddress');
              $('#contact-form').addClass('active');
              $('#icon-contact span').hide();
            ...
            $(document).on('click', '.SanFrancisco', function (e) {
              e.preventDefault();
              $('.openaddress').removeClass('openaddress');
              $('#contact-form').addClass('active');
              $('#icon-contact span').hide();
            ...
            $(document).on('click', '.SanPaulo', function (e) {
              e.preventDefault();
              $('.openaddress').removeClass('openaddress');
              $('#contact-form').addClass('active');
              $('#icon-contact span').hide();
            ...
            $(document).on('click', '.Shanghai', function (e) {
              e.preventDefault();
              $('.openaddress').removeClass('openaddress');
              $('#contact-form').addClass('active');
              $('#icon-contact span').hide();
            ...
            $(document).on('click', '.Singapore', function (e) {
              e.preventDefault();
              $('.openaddress').removeClass('openaddress');
              $('#contact-form').addClass('active');
              $('#icon-contact span').hide();
            ...
            $(document).on('click', '.StPetersburg', function (e) {
              e.preventDefault();
              $('.openaddress').removeClass('openaddress');
              $('#contact-form').addClass('active');
              $('#icon-contact span').hide();
            ...
            $(document).on('click', '.Sydney', function (e) {
              e.preventDefault();
              $('.openaddress').removeClass('openaddress');
              $('#contact-form').addClass('active');
              $('#icon-contact span').hide();
